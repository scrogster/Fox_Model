...
![Figure S2. Posterior densities for the site-level random effects terms for rates of increase of rabbits foxes (top) and rabbits (bottom). Sites are arranged from left to right in order of increasing mean monthly rainfall.](Figures/raneff_violin.png)
