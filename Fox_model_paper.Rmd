---
title: 'Long-term, spatially extensive data reveals weak numerical response of invasive red fox *(Vulpes vulpes)* to abundance of European rabbits: implications for population management'
output: 
  word_document: 
    fig_caption: yes
...
Suggested running title: *Density dependence and numerical responses of red fox populations*

Word Counts: X Summary; X Main Text; X Acknowledgements; X References; X Tables; X Figure Legends.
Number of Tables: 1.
Number of Figures: 4.
