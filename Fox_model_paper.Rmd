...
Where $C_{it}$ is the number of individuals observed during the $i^{th}$ replicate spotlight count, at transect $j$, at time $t$. $l_{ijt}$ were the corresponding lengths of transect surveyed during each census. 

The transect-level abundances $(\mu_{jt})$ of foxes at each site were modelled as a stochastic, density-dependent process:
...
Where $\bar{r}$ is the mean rate of increase, $R_{t}$ is the estimate abundance of rabbits at time $t$, and $\beta_{1}-\beta_{4}$ are regression parameters describing the numerical response of the fox population to rabbit abundance, the strength of density dependence in the rate-of-increase of the fox population, the relationship between rate of increase and the lagged six-monthly rainfall, and whether or not the count was made in the second half of the calendar year. $\zeta_{i}$ are random site-level effects on the rate of increase of the fox population and $\epsilon_{t}$ are normally-distributed errors.
...
Three variables had significant effects on the rate of increase of rabbits: rabbit abundance in the preceding six months, rainfall and season (Table 2, Fig S1). Rabbit abundance in the preceding six months had a negative effect on the rate of increase (i.e. negative density-dependence, Table 2, Fig S1). Interestingly, there was a negative effect of rainfall during the preceding six months on the rate of increase of rabbits (Table 2, Fig S1). After accounting for the effects of both rabbit abundance and rainfall in the preceding six months, the rates of increase of rabbits were significantly higher during autumn to spring than from spring to autumn (Table 2, Fig S1). 
...
Rainfall is thought to be a driver of the abundances of mammalian herbivores and predators in semi-arid and arid systems worldwide [@dennis2000joint; @letnic2004responses; @letnic2011resources; @shaw2012population]. Our 21 monitoring transects included a wide range of mean annual rainfalls (Fig 1), spanning a gradient from semi-arid to temperate climates, and showed strong but opposing effects of rainfall in the preceding six months for rabbits and foxes. Contrary to expectations [@Pech_alternativeprey], increasing rainfall in the preceding six months had a negative effect on rabbit abundance, after other sources of variation were accounted for. Our analysis cannot elucidate the reason for this effect on rainfall on rabbit abundances, but it could be due to increased mortality of rabbits by drowning in their warrens [@bowen1998population; @robson1993natural; @thompson1994european].

NEED TO ADD IN HERE A BIT MORE ABOUT PARADOXICAL RABBIT RESULT
DR suggests;
1. Six-month lag period may be less appropriate for rabbits, which respond more rapidly to rainfall than foxes (rerun with zero lag on this effect?)
2. Most sites have active rabbit management, so rabbit populations are kept in check by active management and can't respond to the opportunity for increased survival or recruitment that high rainfall would otherwise present.
3. Timing of RHD outbreaks may also be relevant - these typically occur during autumn, so may counteract initial spring-time increases in rabbit abundance in response to high rainfall conditions.
