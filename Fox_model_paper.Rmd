---
title: Long-term, spatially extensive data reveals weak numerical response of invasive red fox *Vulpes vulpes* to abundance of European rabbits: implications for pest management
output: 
  word_document: 
    fig_caption: yes
...
Examination of trace plots for the regression parameters and error terms indicated that the Markov chains were well mixed (Figs and S6). The Rubin-Gelman statistic was $\le 1.1$ for all parameters (Figs S7 and S8). Hence, satisfactory convergence of the Markov chains was judged to have been achieved. 
