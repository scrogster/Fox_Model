...
We modelled the time-series of twice-annual observations of rabbit and fox abundance from the 21 transects using an hierarchical, Bayesian state-space model [@buckland2004state]. The model included the effects of rainfall and density dependence on both species, as well as the effects of rabbit abundance on the rate of increase of fox populations [i.e., the numerical response, @bayliss2002numerical].
